...
class PlantVillageDataset(ImageFolder):
    def __init__(self, root, train=True, transform=None, target_transform=None, loader=default_loader):
        super().__init__(os.path.join(root, 'train' if train else 'val'), transform, target_transform, loader)
...
def build_dataset(is_train, args):
    ...
    if args.data_set == 'PLANTVILLAGE':
        dataset = PlantVillageDataset(args.data_path, train=is_train, transform=transform)
